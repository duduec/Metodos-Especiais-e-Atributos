...
class Livro:
    ...
    def __init__(self, titulo, autor, ano_publicacao):
        ...
        Livro.livros.append(self)  # adiciona o livro automaticamente à lista
...
def verificar_disponibilidade(ano):
    livros_disponiveis = [
        livro for livro in Livro.livros if livro.ano_publicacao == ano and livro.disponivel
    ]
...
# from livro import Livro  # exemplo correto se você salvar a classe em um arquivo separado chamado livro.py
